...
public class CloudController : MonoBehaviour
{
    ...
    private void UpdateDisplay()
    {
        ...
        var ekstra = (Vector3)(Random.insideUnitCircle.normalized * Random.Range(newDistance.x, newDistance.y));
        transform.position = PlayerController.Instance.transform.position + ekstra;
    }
}